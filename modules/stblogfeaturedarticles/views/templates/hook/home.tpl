        ...
        <section class="products_section" >
            <div class="products_slider {if $p_c.grid==1} display_as_grid {elseif $p_c.grid==2} display_as_simple {/if}">
                ...
                <div class="title_block flex_container title_align_{if $column_slider}0{else}{(int)$p_c.title_align}{/if} title_style_{if isset($is_blog) && $is_blog}{(int)$stblog.heading_style}{else}{(int)$sttheme.heading_style}{/if} {if isset($p_c.sub_title) && $p_c.sub_title} st_has_sub_title {/if}">
                    ...
                    {if isset($p_c.view_more) && $p_c.view_more==2 && $p_c.link}<div class="flex_box"><a href="{$p_c.link}" class="go view_more_at_tr" title="{l s='View more' d='Shop.Theme.Transformer'}">{l s='View More' d='Shop.Theme.Transformer'}</a></div>{/if}
                ...
                {if isset($p_c.sub_title) && $p_c.sub_title}<div class="slider_sub_title">{$p_c.sub_title nofilter}</div>{/if}
                ...
                {if isset($p_c.blogs) && $p_c.blogs}
                    ...
                    <div class="block_content  {if $p_c.lazy} lazy_swiper {/if}">
                    ...
                    {/if}
                    {if isset($p_c.view_more) && $p_c.view_more==1 && $p_c.link}<div class="product_view_more_box text-center p-t-1"><a href="{$p_c.link}" class="btn btn-default btn-more-padding btn-large" title="{l s='View more' d='Shop.Theme.Transformer'}">{l s='View more' d='Shop.Theme.Transformer'}</a></div>{/if}
                {else}
