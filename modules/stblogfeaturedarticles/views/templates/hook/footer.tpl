...
{if isset($blog_categories) && count($blog_categories)}
    ...
    {foreach $blog_categories as $p_c}
        ...
        <section id="blog_categories_footer_{$hook_hash}" class="blog_categories_footer footer_block block {if $p_c.hide_mob_fot == 1} hidden-md-down {elseif $p_c.hide_mob_fot == 2} hidden-lg-up {/if} {if !isset($is_stacked_footer) || !$is_stacked_footer}col-lg-{if $p_c.footer_wide}{$p_c.footer_wide}{else}3{/if}{/if}{if $p_c.hide_mob_fot == 3} st_open{/if}">
