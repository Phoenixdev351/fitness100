...
class StBlogFeaturedArticles extends BaseSlider
{
    ...
    public static $location = array(
        ...
        35  => array('id' =>35 , 'name' => 'Left column on the product page only'    , 'hook' => 'LeftColumnProduct', 'column'=>1),
        15  => array('id' =>15 , 'name' => 'Right column on the product page only'    , 'hook' => 'RightColumnProduct', 'column'=>1),
        ...
        else
        {
            ...
            foreach($result as $k=>&$v)
            {
                ...
                if ($this->type == 2) {
                    ...
                    $v['name'] = $category->is_root_category ? $this->getTranslator()->trans('Featured articles', array(), 'Shop.Theme.Transformer') : $category->name;
