...
<section id="{$module}_footer_{$hook_hash}" class="{$module}_footer footer_block block {if $hide_mob == 1} hidden-md-down {elseif $hide_mob == 2} hidden-lg-up {/if}{if !isset($is_stacked_footer) || !$is_stacked_footer} col-lg-{if $footer_wide}{$footer_wide}{else}3{/if}{/if} {if $hide_mob==3} st_open{/if}">
