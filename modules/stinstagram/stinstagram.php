...
*/
    ...
    public function _getUserListHtml(){
        ...
        $fields_list = array(
            ...
            'username' => array(
                'title' => $this->getTranslator()->trans('UserName', array(), 'Admin.Theme.Transformer'),
                'width' => 200,
                'type' => 'text',
                'search' => false,
                'orderby' => false
            ...
            'userid' => array(
                'title' => $this->getTranslator()->trans('User Id', array(), 'Admin.Theme.Transformer'),
                'width' => 200,
                'type' => 'text',
                'search' => false,
                'orderby' => false
            ...
            'utoken' => array(
				'title' => $this->getTranslator()->trans('Token', array(), 'Admin.Theme.Transformer'),
				'width' => 200,
				'type' => 'text',
            ...
            'shop_ids' => array(
                'title' => $this->getTranslator()->trans('Shop', array(), 'Admin.Theme.Transformer'),
                'class' => '',
                'type' => 'text',
    ...
    public function bingdinginst($id=0){
        ...
        $fields_form[0]['form']['buttons'] = array(
            array(
                'type' => 'submit',
                'title'=> $this->getTranslator()->trans(' Save', array(), 'Admin.Theme.Transformer'),
    ...
    public function format_date($time){
		...
		$f=array(
			'31536000'=>[$this->getTranslator()->trans('year ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('years ago',array(), 'Shop.Theme.Transformer')],
			'2592000'=>[$this->getTranslator()->trans('month ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('months ago',array(), 'Shop.Theme.Transformer')],
			'604800'=>[$this->getTranslator()->trans('week ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('weeks ago',array(), 'Shop.Theme.Transformer')],
			'86400'=>[$this->getTranslator()->trans('day ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('days ago',array(), 'Shop.Theme.Transformer')],
			'3600'=>[$this->getTranslator()->trans('hour ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('hours ago',array(), 'Shop.Theme.Transformer')],
			'60'=>[$this->getTranslator()->trans('minute ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('minutes ago',array(), 'Shop.Theme.Transformer')],
			'1'=>[$this->getTranslator()->trans('second ago',array(), 'Shop.Theme.Transformer'),$this->getTranslator()->trans('seconds ago',array(), 'Shop.Theme.Transformer')],
		);
		foreach ($f as $k=>$v)    {
    ...
    function vc_map_init()
    {
        ...
        foreach($data AS $value) {
            $content[$this->getTranslator()->trans('ID:', array(), 'Admin.Theme.Transformer').$value['id_st_instagram'].' '.$value['user_name'].' '.$value['hash_tag']] = $value['id_st_instagram'];
        ...
        $params = array(
            ...
            'params' => array(
                ...
                array(
                    ...
                    'code' => '<a href="'.$this->context->link->getAdminLink('AdminModules', false).'&configure='.$this->name.'&module_name='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules').'" target="_blank" class="st_conf_link">'.$this->getTranslator()->trans('Go to the module to change settings.', array(), 'Admin.Theme.Transformer').'</a>',
                ),
                array(
                    'type' => 'html',
