...
jQuery(function($){
    ...
    var clear_cache_in_progress = false;
    $(document).on('click', '.clear_cache_btn', function(e){
        e.preventDefault();
        if(clear_cache_in_progress)
            return false;
        clear_cache_in_progress = true;
        $('#clear_cache_warning').show();
        ...
        $.ajax(
          {
            ...
            clear_cache_in_progress = false;
            $('#clear_cache_warning').hide();
            //
          }).fail(function (resp) {
            clear_cache_in_progress = false;
            $('#clear_cache_warning').hide();
