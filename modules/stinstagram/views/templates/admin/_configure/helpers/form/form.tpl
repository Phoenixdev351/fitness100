...
{extends file="helpers/form/form.tpl"}{block name="autoload_tinyMCE"}
	...
	tinySetup({
		...
		toolbar1 : "code,|,bold,italic,underline,strikethrough,|,alignleft,aligncenter,alignright,alignjustify,formatselect,|,blockquote,colorpicker,pasteword,|,bullist,numlist,|,outdent,indent,|,link,unlink,|,cleanup,|,media,image,|,template",
