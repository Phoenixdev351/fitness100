...
<section class="{if !isset($is_stacked_footer) || !$is_stacked_footer}col-lg-{if $st_fb_lb_wide_on_footer}{$st_fb_lb_wide_on_footer}{else}3{/if}{/if} block footer_block rt_fb_like_box{if $st_lb_hide_on_mobile == 1} hidden-md-down {elseif $st_lb_hide_on_mobile == 2} st_open {/if}">
