...
<section class="{if $hide_mob == 1} hidden-md-down {elseif $hide_mob == 2} hidden-lg-up {/if} pcomment_footer {if !isset($is_stacked_footer) || !$is_stacked_footer}col-lg-{if $footer_wide}{$footer_wide}{else}3{/if}{/if} footer_block block{if $hide_mob==3} st_open{/if}">
