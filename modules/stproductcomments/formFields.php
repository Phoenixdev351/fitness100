...
$form_fields['list'] = array(
    'list_page_title' => array(
        'type' => 'text',
        'label' => $this->getTranslator()->trans('Page title:', array(), 'Admin.Theme.Transformer'),
    ...
    'list_page_keyword' => array(
        'type' => 'text',
        'label' => $this->getTranslator()->trans('Seo keywords:', array(), 'Admin.Theme.Transformer'),
    ...
    'list_page_description' => array(
        'type' => 'text',
        'label' => $this->getTranslator()->trans('Seo description:', array(), 'Admin.Theme.Transformer'),
