...
class StCurrencyselector extends Module implements WidgetInterface
{
	...
	public function __construct()
	{
        ...
        $this->templateFile = array(
            ...
            'module:stcurrencyselector/views/templates/hook/stcurrencyselector-side.tpl',
            );
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Currency label:', array(), 'Modules.Stcurrencyselector.Admin'),
    ...
    public function renderWidget($hookName, array $configuration)
    {
        ...
        return $this->fetch($hookName=='displayMobileNav' || $hookName=='displayCheckoutMobileNav' ? $this->templateFile[1] : ($hookName=='displaySideBar' ? $this->templateFile[2] : $this->templateFile[0]));
    }
