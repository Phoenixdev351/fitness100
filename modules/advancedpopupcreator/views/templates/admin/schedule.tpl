...
<script>
    ...
    var businessHoursManager = $("#scheduleContainer").businessHours({
        ...
        weekdays:[{l s='\'Monday\',\'Tuesday\',\'Wednesday\',\'Thursday\',\'Friday\',\'Saturday\',\'Sunday\'' mod='advancedpopupcreator'}],
...
<style>
    ...
    .time-column.valid-date-icon { color: #72c279; }
    .time-column.future-date-icon { color: #f3e838; }
    .time-column.expired-date-icon { color: #e08f95; }

    .time-column [class^="icon-"] { font-size: 18px !important; }
    ...
    .dayContainer .weekday { text-align: center; }
    .operationTime [class^="icon-"]:before, [class*=" icon-"]:before { margin: 0 !important;}
