        ...
        {/if}
            <div class="col-lg-9">
                <div class="form-group">
                    <div class="col-sm-6">
                        <input id="{$id_image|escape:'html':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}" type="file" name="{$name_image|escape:'html':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}"" class="hide" />
                        <div class="dummyfile input-group">
                            <span class="input-group-addon"><i class="icon-file"></i></span>
                            {assign var="varName" value="filename_{$language.id_lang}"}
