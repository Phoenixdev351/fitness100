...
class StHoverImage extends Module
{
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            array(
                'type' => 'html',
                'label' => $this->getTranslator()->trans('Cron URL:', array(), 'Modules.Sthoverimage.Admin'),
                'name' => $this->context->link->getModuleLink('sthoverimage', 'cron', array('token' => Tools::getToken('sthoverimage'))),
            ),
			'submit' => array(
