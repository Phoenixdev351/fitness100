...
class StLovedProduct extends Module implements WidgetInterface
{
	...
	public function __construct()
	{
        ...
        self::$position = array(
            ...
            11 => array(
                'id' => 'pos_11',
                'value' => 11,
                'label' => $this->getTranslator()->trans('Beside product name', array(), 'Admin.Theme.Transformer')
            ),
        ); 
    ...
    {
        $this->_tabs = array(
            array('id'  => '0,1,6,5', 'name' => $this->getTranslator()->trans('General settings', array(), 'Admin.Theme.Transformer')),
	...
	public function install()
	{
		$res = parent::install()
            ...
            && Configuration::updateValue($this->_prefix_st.'SHOW_LOVE_ICON', 0)
            ...
            && Configuration::updateValue($this->_prefix_st.'LOGIN', 0)
	...
	public function getContent()
	{
        ...
        if(!Module::isInstalled('statsdata') || !Module::isEnabled('statsdata'))
            $this->_html .= $this->displayError($this->getTranslator()->trans('The "Data mining for statistics" module is disabled/uninstalled on your site, guests will be asked to login. If you want to make this module be available for guests and customers, then you need to enale/install the "Data mining for statistics" module.', array(), 'Modules.Stlovedproduct.Admin'));
    ...
    protected function initForm()
    {
        $this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('People have to login to love products:', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'login',
                    'default_value' => 0,
                    'values' => array(
                        array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active color:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to display link in the header:', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'header_style',
                    'default_value' => 1,
                    'values' => array(
                        array(
                        ...
                        array(
                            ...
                            'value' => 3,
                            'label' => $this->getTranslator()->trans('Icon + Text (Vertical)', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'header_style_badge',
                            'value' => 4,
                            'label' => $this->getTranslator()->trans('Icon + badge', array(), 'Admin.Theme.Transformer')),
                        array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon size in the header:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Text size in the header:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('How many products show in the sidebar', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'nbr_sidebar',
                    'default_value' => 6,
                    'validation' => 'isUnsignedInt',
                    'class' => 'fixed-width-sm'
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('When to show the love button when they are on the product image:', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'show_love_icon',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'show_love_icon_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Show love icons out when mouse hover.', array(), 'Admin.Theme.Transformer')),
                        array(
                            'id' => 'show_love_icon_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Show out all the time.', array(), 'Admin.Theme.Transformer')),
                    ),
                    'validation' => 'isUnsignedInt',
                ),
			),
        ...
        $this->fields_form[6]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Settings for love icons on the product image', array(), 'Admin.Theme.Transformer'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
        ...
        $this->fields_form[5]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTransLator()->trans('Display the number of loves:', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'with_number',
                    'default_value' => 1,
                    'is_bool' => true,
                    'values' => array(
                    ...
                    'validation' => 'isBool',
                    'desc' => $this->getTranslator()->trans('For cacheing reason the number of loves can only be display on the product page.', array(), 'Admin.Theme.Transformer'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon size:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active Icon color:', array(), 'Admin.Theme.Transformer'),
    ...
    {
        $mylove = StLovedProductClass::getMyLoved($this->context->customer->id, $this->context->customer->id_guest,0,0);
        $stlove_bos = $stlove_pros = array();
        if($mylove){
            foreach ($mylove as $value) {
                if($value['type']==1)
                    $stlove_pros[] = $value['id_source'];
                if($value['type']==2)
                    $stlove_bos[] = $value['id_source'];
            }
        }
        Media::addJsDef(array(
            'st_myloved_url' => $this->context->link->getModuleLink('stlovedproduct', 'myloved'),
            'stlove_pros' => $stlove_pros,
            'stlove_bos' => $stlove_bos,
            'stlove_login'         => (int)Configuration::get($this->_prefix_st.'LOGIN'),
        ));
        ...
        if (!$this->isCached($this->templatePath.'header.tpl', $this->getCacheId()))
        {
            ...
            if($text_color = Configuration::get($this->_prefix_st.'TEXT_COLOR'))
                $custom_css .= '.add_to_love, .add_to_love:hover{color:'.$text_color.';}';
            if($text_hover_color = Configuration::get($this->_prefix_st.'TEXT_HOVER_COLOR'))
                $custom_css .= '.add_to_love.st_added, .add_to_love.st_added:hover{color:'.$text_hover_color.';}';
            ...
            if($icon_size = Configuration::get($this->_prefix_st.'HEADER_ICON_SIZE')){
                $custom_css .= '.loved_link.top_bar_item .header_icon_btn_icon i{font-size:'.$icon_size.'px;}';
            }
            if($text_size = Configuration::get($this->_prefix_st.'HEADER_TEXT_SIZE')){
                $custom_css .= '.loved_link.top_bar_item .header_icon_btn_text{font-size:'.$text_size.'px;}';
            }
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        $type = 1;
        $this->smarty->assign($this->getWidgetVariables()); // easy_trans_panda he easymenu huo qu bu dao displayheader limian, suo yi zhe hai yao zhi xin yici.
        ...
        if($in_product_page || $is_blog)
        {
            ...
            if($id_source)
            {
                ...
                $vars['classname'] = 'btn_inline love_item '.($in_product_page ? 'love_product' : '').' '.(($this->context->customer->id || $this->context->customer->id_guest) && StLovedProductClass::exists($id_source, $this->context->customer->id, $this->context->customer->id_guest, $type) ? ' st_added ' : '');
        ...
        if($in_header){
            $this->smarty->assign(
                'stlove_total', StLovedProductClass::getMyLovedCount($this->context->customer->id, $this->context->customer->id_guest)
            );
        }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        return array(
            ...
            'loved_show_love_icon'     => Configuration::get($this->_prefix_st.'SHOW_LOVE_ICON'),
            // 'loved_with_number'      => Configuration::get($this->_prefix_st.'WITH_NUMBER'),
            ...
            'loved_login'         => Configuration::get($this->_prefix_st.'LOGIN'),
    ...
    public function hookDisplaySideBar($params)
    {
        ...
        $my_loved = StLovedProductClass::getMyLoved($this->context->customer->id, $this->context->customer->id_guest, $nbr, 2);
        ...
        $my_loved = StLovedProductClass::getMyLoved($this->context->customer->id, $this->context->customer->id_guest, $nbr, 1);
        if($my_loved && count($my_loved))
        {    
    ...
    private function getConfigFieldsValues()
    {
        $fields_values = array(
            ...
            'show_love_icon'      => Configuration::get($this->_prefix_st.'SHOW_LOVE_ICON'),
            ...
            'login'       => Configuration::get($this->_prefix_st.'LOGIN'),
    ...
    {
        // $count = StLovedProductClass::getTotal($product['id_product'], 1);
        return array(
            'loved' => ($this->context->customer->id || $this->context->customer->id_guest) ? StLovedProductClass::exists($product['id_product'], $this->context->customer->id, $this->context->customer->id_guest, 1) : 0,
            );
    }
    public function hookActionAuthentication($params)
    {
        // update loved from guest to customer after login.
        $id_customer = $params['customer']->id;
        $id_guest = $this->context->customer->id_guest?:(int)Guest::getFromCustomer($id_customer);
        if ($id_guest) {
            Db::getInstance()->execute('UPDATE `'._DB_PREFIX_.'st_loved_product` SET `id_customer`=`id_guest` WHERE `id_guest`='.(int)$id_guest.' AND `id_shop` ='.(int)Context::getContext()->shop->id);
        }
    }
}