...
{if isset($slides)}
    {if isset($slides['slide']) && count($slides['slide'])}
        ...
        {include file="module:stswiper/views/templates/hook/stswiper-script.tpl" one_item_only={count($slides['slide'])}}
    {/if}
{/if}
<!--/ MODULE stswiper -->