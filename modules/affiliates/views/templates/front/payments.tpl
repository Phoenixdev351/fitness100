		...
		<div class="panel-payments">
				...
				<table class="table table-bordered {if $ps_version < 1.6}std{/if}">
					<tbody>
						...
						<tr id="pending_rewards">
							...
							<td class="amount text-right nowrap">{Tools::displayPrice(Tools::convertPriceFull($pending_rewards, null, $currency))|escape:'htmlall':'UTF-8'}</td>
						</tr>
						<tr id="paid_rewards">
							<td class="text-right first_row">{l s='Paid Amount' mod='affiliates'}</td>
							<td class="amount text-right nowrap">{Tools::displayPrice(Tools::convertPriceFull($total_paid, null, $currency))|escape:'htmlall':'UTF-8'}</td>
						</tr>
						<tr id="awaiting_rewards">
							<td class="text-right first_row">{l s='Awaiting Payment Validation' mod='affiliates'}</td>
							<td class="amount text-right nowrap">{Tools::displayPrice(Tools::convertPriceFull($awaiting_payments, null, $currency))|escape:'htmlall':'UTF-8'}</td>
						</tr>
			...
			{if isset($PAYMENT_METHOD) AND $PAYMENT_METHOD}
				{if isset($av_balance) AND $av_balance}
					...
					{else}
						<a id="request-payment" href="javascript:void(0);" class="button btn" onclick="$('#vrewards-list').toggle();">
					...
					<div id="vrewards-list" class="table-responsive" style="display:none;">
							...
							{if (isset($paypal_details) AND !empty($paypal_details.details)) OR (isset($bankwire_details) AND !empty($bankwire_details.details))}
								...
								{if isset($PAYMENT_METHOD) AND in_array(2, $PAYMENT_METHOD) AND isset($bankwire_details) AND $bankwire_details.details}
									<td id="pd_2" class="center first_row">
										<label>{l s='Bank ACH' mod='affiliates'}</label>
									</td>
								{/if}
			            ...
			            {if (isset($paypal_details) AND !empty($paypal_details.details)) OR (isset($bankwire_details) AND !empty($bankwire_details.details)) OR (isset($ALL_CUSTOM_PAYMENTS) AND $ALL_CUSTOM_PAYMENTS AND isset($selected_custom_pm) AND $cpm)}
			                <div class="pull-right">
								...
								{else}
									<button id="submit-payment-request" class="btn btn-default button button-medium" name="withdraw">
