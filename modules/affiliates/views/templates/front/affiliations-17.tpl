...
{if $isAccess}
                ...
                <div id="main" class="left">
                    ...
                    <div class="tabcontents">
                        ...
                        <div id="affiliation_tab_7" {if $active_tab AND $active_tab != 'affiliation_tab_7'}style="display:none;"{/if}>
                            {include file="module:affiliates/views/templates/front/banners.tpl"}
                        </div>
                        <div class="clearfix"></div>
    ...
    {else}
        ...
        <form id="affiliation-request"
            class="well"
            method="post"
            action="{$link->getModuleLink('affiliates', 'myaffiliates', [], true)|escape:'htmlall':'UTF-8'}">
            <input type="hidden" name="sendAffiliateRequest" value="1">
