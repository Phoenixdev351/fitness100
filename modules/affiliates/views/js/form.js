...
function addProductRuleGroup()
{
    ...
    $.get(
        'ajax-tab.php',
        {controller:'AdminAffiliationDiscounts',token:currentToken,newProductRuleGroup:1,product_rule_group_id:product_rule_groups_counter},
        function(content) {
            if (content != "")
...
function addProductRule(product_rule_group_id)
{
    ...
    if ($('#product_rule_type_' + product_rule_group_id).val() != 0)
        $.get(
            'ajax-tab.php',
            {controller:'AdminAffiliationDiscounts',token:currentToken,newProductRule:1,product_rule_type:$('#product_rule_type_' + product_rule_group_id).val(),product_rule_group_id:product_rule_group_id,product_rule_id:product_rule_counters[product_rule_group_id]},
            function(content) {
                if (content != "")
...
$('#reductionProductFilter')
    .autocomplete(
            ...
            extraParams: {
                controller: 'AdminAffiliationDiscounts',
                token: currentToken,
