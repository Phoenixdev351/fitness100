        ...
        {foreach $archives as $archive}
            <li>
                ...
                {foreach $archive.child as $ar}
                    <li>
                        <div class="acc_header flex_container">
                            <a href="{url entity='module' name='stblogarchives' controller='default' params=['m' => $ar.Ym]}" title="{l s=$ar.M d='Shop.Theme.Transformer'}" class="flex_child">{l s=$ar.M d='Shop.Theme.Transformer'} {$archive.Y2}</a>
                        </div>
                    </li>
                {/foreach}
                </ul>
