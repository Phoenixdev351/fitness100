...
<section id="multilink_{$link_group.id_st_multi_link_group}" class="stlinkgroups_links_footer {if !$link_group.is_stacked_footer}col-lg-{if $link_group.span}{$link_group.span}{else}3{/if}{/if} footer_block block {if $link_group.hide_on_mobile==1} hidden-md-down {elseif $link_group.hide_on_mobile==2 || !$link_group.name} st_open{/if}">
    {if $link_group.name}
