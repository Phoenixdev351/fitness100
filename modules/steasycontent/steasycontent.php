...
class StEasyContent extends Module implements WidgetInterface
{
    ...
    public static $location = array(
        ...
        130    => array('id' =>130 , 'name' => 'Product Additional Info',  'hook' => 'ProductAdditionalInfo'),
        ...
        139 => array('id' =>139 , 'name' => 'Main menu' , 'hook' => 'MainMenu', 'stretched' => 1, 'full_width' => 1),
        140 => array('id' =>140 , 'name' => 'After login form' , 'hook' => 'CustomerLoginFormAfter'),
        
        141 => array('id' =>141 , 'name' => 'Mobile bar nav' , 'hook' => 'MobileNav'),
    );
    // key: type+00
	...
	protected function initForm()
	{
        ...
        if ($easy_content->id) {
            if (in_array($easy_content->type, array(6,7,8,9,10,11,26,27))) {
