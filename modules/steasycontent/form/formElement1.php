    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'fontello',
                    'label' => $this->getTranslator()->trans('Icon:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_el_icon',
                ...
                /*array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Apply link to:', array(), 'Modules.Steasycontent.Admin'),
                    ...
                    'values' => array(
                        array(
                            'id' => 'active_on',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Whole block', array(), 'Modules.Steasycontent.Admin')
                        ),
                        array(
                            'id' => 'active_off',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Link itself', array(), 'Modules.Steasycontent.Admin')
                        )
                    ),
                    'validation' => 'isUnsignedInt',
                ),*/
        ...
        $this->fields_form[5]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon border color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon border size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon border radius:', array(), 'Modules.Steasycontent.Admin'),
                    ...
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => array(
                            $this->getTranslator()->trans('Set a large value for this field to have a round icon.', array(), 'Modules.Steasycontent.Admin'),
                            $this->getTranslator()->trans('Leave it empty to use the default value.', array(), 'Admin.Theme.Transformer'),
                            ),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon size:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_icon_size',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => 0,
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon top spacing:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon bottom spacing:', array(), 'Modules.Steasycontent.Admin'),
        ...
        $this->fields_form[6]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Text settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Sub header bottom spacing:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Apply the same font as header to sub header:', array(), 'Modules.Steasycontent.Admin'),
        ...
        $this->fields_form[7]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Text alignment:', array(), 'Modules.Steasycontent.Admin'),
