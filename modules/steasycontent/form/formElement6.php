    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                'ac_products' => array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Products:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'ac_products',
                    'autocomplete' => false,
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Spacing between products:', array(), 'Modules.Steasycontent.Admin'),
