    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Content font size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Image column width for template 2:', array(), 'Modules.Steasycontent.Admin'),
                    ...
                    'validation' => 'isGenericName',
                    'desc' => $this->getTranslator()->trans('Set it 0 to show text only, set it to 12 to show image only.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'file',
                ...
                array(
                    'type' => 'file',
                    'label' => $this->getTranslator()->trans('Lightbox image:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_image_big',
                    'desc' => $this->getTranslator()->trans('This image will show in a lightbox when customers click one the image above.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Image link:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_image_link',
                    'size' => 64,
                    'lang' => true,
                    'desc' => '<strong>'.$this->getTranslator()->trans('If this field is filled in, the "Lightbox image" option above will be ignored.', array(), 'Modules.Steasycontent.Admin').'</strong>',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Image alt:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_image_alt',
                    'size' => 64,
                    'lang' => true,
                ),
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Image hover effect:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_image_hover',
                    'default_value' => 0,
                    'values' => array(
                        array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Image border color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Image border size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Image border radius:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_image_border_radius',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => '',
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => $this->getTranslator()->trans('Leave it empty to use the default value. Set a large value for this field to have round images.', array(), 'Modules.Steasycontent.Admin'),
                ),              
                array(
                    'type' => 'radio',
        ...
        $this->fields_form[1]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Header settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs',             
            ),
            'input' => array(
                 array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Header bottom border height:', array(), 'Modules.Steasycontent.Admin'),
                 ...
                 array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Header border highlight color:', array(), 'Modules.Steasycontent.Admin'),
        ...
        $this->fields_form[2]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Color settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs',             
            ),
            'input' => array(
                array(
        ...
        $this->fields_form[3]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Block settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
