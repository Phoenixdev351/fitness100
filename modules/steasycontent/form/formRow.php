...
class FormRow extends StEasyContent
{
    public function initFormRow()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans(($this->id_st_easy_content_column?'Edit':'Create').' a row:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Row name:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'name',
                    'class' => 'fixed-width-xxl',
                    'desc' => $this->getTranslator()->trans('Only as a reminder.', array(), 'Modules.Steasycontent.Admin'),
                ),
                'row_generater' => array(
                    'type' => 'row_generater',
                    'label' => '',
