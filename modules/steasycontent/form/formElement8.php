    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Sub header:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Drop cap color / blockquote border color / quotes color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Additional info:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_el_info',
                    'lang' => true,
                    'validation' => 'isGenericName',
                    'desc' => $this->getTranslator()->trans('This can be used to display auther name in testimonal boxes.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Stars:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_el_stars',
                    'options' => array(
                        'query' => array(
                            array('id' => 1, 'name'=> 1),
                    ...
                    'desc' => $this->getTranslator()->trans('This is used to display stars in testimonal boxes.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Button url:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_el_url',
                    'lang' => true,
                    'validation' => 'isGenericName',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('button text:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_el_button',
                    'lang' => true,
                    'validation' => 'isGenericName',
                ),
        ...
        $this->fields_form[5]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => array(
                            $this->getTranslator()->trans('Set a large value for this field to have a round image.', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    ...
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => array(
                            $this->getTranslator()->trans('Leave it empty to use the default 60px.', array(), 'Modules.Steasycontent.Admin'),
                            ),
                ),
            ),
            'buttons' => array(
        ...
        $this->fields_form[6]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'default_value' => 0,
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => $this->getTranslator()->trans('Set it to 0 to use the default value.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Sub header color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Sub header font size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Star color:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_star_color',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Highlight star color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Additional info color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Additional font size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Apply the same font as header to text:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_text_font',
                    'is_bool' => true,
                    'default_value' => 0,
                    'values' => array(
        ...
        foreach ($languages as $lang)
        {
            $this->fields_form[0]['form']['input']['st_image_'.$lang['id_lang']] = array(
                    ...
                    'desc' => $this->getTranslator()->trans('This module would not change image names for seo purpose, so ensure the image you are going to upload has an unique name.', array(), 'Modules.Steasycontent.Admin').'<br/>',
                );
        }
    ...
    public function initFormElementSetting()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to display element items:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_grid',
                    'default_value' => 0,
                    'values' => array(
                        array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Spacing between items:', array(), 'Modules.Steasycontent.Admin'),
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'name' => 'st_s_speed',
                    'default_value' => 7000,
                    'desc' => $this->getTranslator()->trans('The period, in milliseconds, between the end of a transition effect and the start of the next one.', array(), 'Modules.Steasycontent.Admin'),
                    'validation' => 'isUnsignedInt',
                    'class' => 'fixed-width-sm'
                ),
                array(
