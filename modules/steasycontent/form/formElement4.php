...
class FormElement4 extends StEasyContent
{
    ...
    public function initFormElementSetting()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Tab settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs',                
            ),
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Tab font size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Tab color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active tab color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Tab background:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_header_bg',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active tab background:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Border color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active border color:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_header_active_border',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                    'desc' => $this->getTranslator()->trans('Some styles do not have active border.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Bottom border size:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_tab_bottom_border',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'default_value' => '',
                    'validation' => 'isNullOrUnsignedId',
                    'desc' => $this->getTranslator()->trans('This does not work for all style, cause some them do not have bottom border.Set it empty to use the default value.', array(), 'Modules.Steasycontent.Admin'),
                ),
            ),
            'buttons' => array(
                array(
        ...
        $this->fields_form[1]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Content settings:', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
                ...
                array(
                    ...
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'desc' => $this->getTranslator()->trans('You can set a special top padding. Leave it empty to use the default value.', array(), 'Modules.Steasycontent.Admin'),
                ),
            ),
            'buttons' => array(
                array(
