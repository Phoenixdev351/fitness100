        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc' => array(
                            $this->getTranslator()->trans('HTML code supported.', array(), 'Modules.Steasycontent.Admin'),
                            $this->getTranslator()->trans('Use code like this to add icons', array(), 'Modules.Steasycontent.Admin').'&lt;i class="fto-glyph"&gt;&lt;/i&gt;',
                        ),
                ),
                array(
                    'type' => 'fontello_list',
