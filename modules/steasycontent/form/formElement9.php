    ...
    public function initFormElement()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
					'type' => 'text',
					'label' => $this->getTranslator()->trans('Accept button:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
					'type' => 'text',
					'label' => $this->getTranslator()->trans('More info button:', array(), 'Modules.Steasycontent.Admin'),
					'name' => 'st_more_info',
					'lang' => true,
					'size' => 64,
				),
                array(
					'type' => 'select',
					'label' => $this->getTranslator()->trans('More info link:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to show this box:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_show_box',
                    'default_value' => 0,
                    'is_bool' => true,
                    'validation' => 'isUnsignedInt',
                    'values' => array(
                        array(
                            'id' => 'show_box_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('At all time with a do not show option', array(), 'Modules.Steasycontent.Admin')),
                        array(
                            'id' => 'show_box_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('At all time', array(), 'Modules.Steasycontent.Admin')),
                        array(
                            'id' => 'show_box_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('First time only', array(), 'Modules.Steasycontent.Admin')),
                    ),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Delay:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_delay',
                    'default_value' => 2,
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                 ...
                 array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Block broder color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Overlay color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Overlay opacity:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_bg_opacity_nohover',
                    'validation' => 'isFloat',
                    'class' => 'fixed-width-lg',
                    'desc' => $this->getTranslator()->trans('From 0.0 (fully transparent) to 1.0 (fully opaque).', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Overlay opacity when mouseover:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_bg_opacity',
                    'validation' => 'isFloat',
                    'class' => 'fixed-width-lg',
                    'desc' => $this->getTranslator()->trans('From 0.0 (fully transparent) to 1.0 (fully opaque).', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Button color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Button background color:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_button_bg',
                    'size' => 33,
                    'validation' => 'isColor',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Button font size:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('H-shadow:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_h_shadow',
                    'validation' => 'isInt',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'desc' => $this->getTranslator()->trans('The position of the horizontal shadow. Negative values are allowed.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('V-shadow:', array(), 'Modules.Steasycontent.Admin'),
                    'name' => 'st_v_shadow',
                    'validation' => 'isInt',
                    'prefix' => 'px',
                    'class' => 'fixed-width-lg',
                    'desc' => $this->getTranslator()->trans('The position of the vertical shadow. Negative values are allowed.', array(), 'Modules.Steasycontent.Admin'),
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Shadow color:', array(), 'Modules.Steasycontent.Admin'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Shadow opacity:', array(), 'Modules.Steasycontent.Admin'),
