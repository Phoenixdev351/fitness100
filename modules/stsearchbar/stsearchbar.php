...
class StSearchbar extends Module implements WidgetInterface
{
        ...
        $this->_hooks = array(
            'Hooks' => array(
                ...
                array(
                    'id' => 'displaySearch',
                    'val' => '1',
                    'name' => $this->getTranslator()->trans('displaySearch', array(), 'Admin.Theme.Transformer'),
                ),
            )
        );
    }
    ...
    protected function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Search box width in the header:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'checkbox',
                    'label' => $this->getTranslator()->trans('Elements in the search result', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('How many items in the search result:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Placeholder:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'placeholder',
                    'validation' => 'isAnything',
                    'lang' => true,
                ),
        ...
        $this->fields_form[3]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Popup search box', array(), 'Admin.Theme.Transformer'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Search box height:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Search box font size:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    ...
                    'size' => 33,
                    'validation' => 'isColor',
                    'desc' => $this->getTranslator()->trans('Set it to the same color as the background to make the border invisiable.', array(), 'Admin.Theme.Transformer'),
                ),
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Search field background color:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Search field text color:', array(), 'Admin.Theme.Transformer'),
    ...
    public function hookDisplayHeader($params)
    {
        ...
        if (!$this->isCached('module:stsearchbar/views/templates/hook/header.tpl', $this->getCacheId()))
        {   
            $custom_css = '';
