...
<div class="dtm-right-block">
    ...
    {/if}
    <form id="module_form" action="{$link->getAdminLink('AdminDataMasterImport')|escape:'html':'UTF-8'}" class="defaultForm form-horizontal" novalidate="" enctype="multipart/form-data" method="post" >
        ...
        <div id="fieldset_0" class="panel">
            ...
            <ul class="tab_step_data">
                ...
                <li class="data_number_step{if $step==3} active{/if}" data-step="3"><span>3</span>{l s='Import options' mod='ets_oneclicktomigrate'}</li>
                ...
                <div class="ybc-form-group ybc-blog-tab-step1 {if $step==1} active{/if}">
                    ...
                    {else}
                            ...
                            <div class="col-lg-8">
                                <div class="data_upload_button_wrap">
                                    ...
                                    <div class="data_upload_button">
                                        <input type="text" name="data_upload_button" id="data_upload_button_input" value="{l s='No file selected.' mod='ets_oneclicktomigrate'}" />
                                        <div class="data_upload_button_right">
                                            <i class="icon icon-file"></i> {l s='Choose file' mod='ets_oneclicktomigrate'}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group source url_site">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="link_site" id="link_site" placeholder="{l s='Enter site URL (eg: http://yourwebsite.com/modules/ets_pres2presconnector/connector.php)' mod='ets_oneclicktomigrate'}" />
                            </div>
                        </div>
                        <div class="form-group source url_site">
                            ...
                            <div class="col-lg-8">
                                <input style="width: 100%;" type="text" name="secure_access_tocken" id="secure_access_tocken" placeholder="{l s='Secure access token' mod='ets_oneclicktomigrate'}" />
                            </div>
                        </div>
                    ...
                    <div class="popup_uploading_table">
                        <div class="popup_uploading_tablecell">
                            <div class="popup_uploading_content">
                                {l s='Uploading data, please wait...!' mod='ets_oneclicktomigrate'}
            ...
            <div class="panel-footer">
                <button id="module_form_submit_btn" class="btn btn-default pull-right" name="submitImport" value="1" type="submit" >
