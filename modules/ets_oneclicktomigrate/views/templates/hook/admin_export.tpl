            ...
            <div class="form-wrapper">
                <div class="ybc-form-group ybc-blog-tab-step1{if $step==1} active{/if}">
                    <div class="form-group">
    				    <label class="control-label">{l s='Which data do you want to export?' mod='ets_oneclicktomigrate'}</label>
    				    <div class="col-lg-9">
                            ...
                            <div class="checkbox">
    				            <label for="data_export_vouchers"><input{if in_array('vouchers',$ets_datamaster_export)} checked="checked"{/if} name="data_export[]" value="vouchers" type="checkbox" id="data_export_vouchers" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Vouchers' mod='ets_oneclicktomigrate'}</label>
                            </div>
                            <div class="checkbox">
                    ...
                    <div class="popup_exporting_table">
                        <div class="popup_exporting_tablecell">
                            <div class="popup_exporting_content">
                                {l s='We are processing the export data, please wait and do not close web browser! This process can take some minutes depending on your server speed and your data size' mod='ets_oneclicktomigrate'}
