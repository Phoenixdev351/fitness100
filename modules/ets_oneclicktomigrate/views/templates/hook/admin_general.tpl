...
<div class="dtm-right-block">
    <div id="data-master">
        ...
        <div class="export">
            <a href="index.php?tab=AdminModules&configure=ets_oneclicktomigrate&token={$token|escape:'html':'UTF-8'}&tab_module=front_office_features&module_name=ets_oneclicktomigrate&tabmodule=export">{l s='Export data' mod='ets_oneclicktomigrate'}</a>
            <ul>
        ...
        <div class="import">
            <a href="index.php?tab=AdminModules&configure=ets_oneclicktomigrate&token={$token|escape:'html':'UTF-8'}&tab_module=front_office_features&module_name=ets_oneclicktomigrate&tabmodule=import">{l s='Import data' mod='ets_oneclicktomigrate'}</a>
            <ul>
