...
class StShoppingcart extends Module implements WidgetInterface
{
                    ...
                    array(
                        ...
                        'values' => array(
                            array(
                                ...
                                'value' => 0,
                                'label' => $this->getTranslator()->trans('Default style', array(), 'Modules.Stshoppingcart.Admin')),
                            array(
                    ...
                    array(
                        ...
                        'values' => array(
                                array(
                                    'id' => 'checkout_cart',
                                    'value' => 0,
                                    'label' => $this->getTranslator()->trans('A shopping cart button', array(), 'Admin.Theme.Transformer')
                                ),
                                array(
                                    'id' => 'checkout_checkout',
                                    'value' => 1,
                                    'label' => $this->getTranslator()->trans('A checkout button', array(), 'Admin.Theme.Transformer')
                                ),
                                array(
                                    'id' => 'checkout_both',
                                    'value' => 2,
                                    'label' => $this->getTranslator()->trans('A shopping cart button and a checkout button', array(), 'Admin.Theme.Transformer')
                                ),
                                array(
                                    'id' => 'checkout_sc',
                                    'value' => 3,
                                    'label' => $this->getTranslator()->trans('A shopping cart button and a close button', array(), 'Admin.Theme.Transformer')
                                ),
                                array(
                                    'id' => 'checkout_cc',
                                    'value' => 4,
                                    'label' => $this->getTranslator()->trans('A checkout button and a close button', array(), 'Admin.Theme.Transformer')
                                ),
                            ),
	...
	public function hookDisplayHeader($params)
	{
        ...
        {   
            ...
            {
                $custom_css .= '.top_bar_item.shopping_cart_style_0 .cart_icon_item, .top_bar_item.shopping_cart_style_2 .cart_icon_item, .top_bar_item.shopping_cart_style_3 .cart_icon_item{height:'.$quick_search_input_height.'px;line-height:'.($quick_search_input_height-2).'px;}';
