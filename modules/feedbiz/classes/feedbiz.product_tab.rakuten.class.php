...
class FeedBizProductTabRakuten extends FeedBizProductTab
{
    /** @var array */
    ...
    /**
     * FeedBizProductTabRakuten constructor.
     *
    ...
    /**
     * Generate product tab for Rakuten
     *
     * @param $product
     * @param $combinations
     *
    ...
    public static function getProductOptionFields()
    {
        ...
        $option_fields_config = Configuration::get('FEEDBIZ_OPTION_FIELDS_RAKUTEN', null, 0, 0);
    ...
    public function countrySelector()
    {
        ...
        foreach (Feedbiz::$rakuten_regions as $domain => $region) {
            ...
            $marketplaces[$region]['name'] = sprintf('Rakuten %s', FeedbizTools::rakutenRegionToDomain($region));
    ...
    public static function getProductOptions($id_product, $id_product_attribute = null, $region = null)
    {
        ...
        $sql = 'SELECT *
                FROM `'._DB_PREFIX_.Feedbiz::TABLE_FEEDBIZ_RAKUTEN.'` p
    ...
    public static function setProductOptions($id_product, $region, $options, $id_product_attribute = null)
    {
        ...
        $sql = 'REPLACE INTO `'._DB_PREFIX_.Feedbiz::TABLE_FEEDBIZ_RAKUTEN.'`
    ...
    public static function propagateProductOptionToCategory($region, $id_category, $field, $value)
    {
        ...
        $sql = 'INSERT INTO `'._DB_PREFIX_.Feedbiz::TABLE_FEEDBIZ_RAKUTEN.'`
    ...
    public static function updateProductOptions($id_product, $options, $region, $id_product_attribute = null)
    {
        ...
        if (self::getProductOptions($id_product, $id_product_attribute, $region)) {
            ...
            $sql_update = 'UPDATE `'._DB_PREFIX_.Feedbiz::TABLE_FEEDBIZ_RAKUTEN.'` SET '.rtrim(trim($sql), ',').'
    ...
    */
    public static function deleteProductOptions($id_product, $region, $id_product_attribute = null)
    {
        ...
        $sql = 'DELETE FROM `'._DB_PREFIX_.Feedbiz::TABLE_FEEDBIZ_RAKUTEN.'` WHERE `id_product` ='.(int)$id_product.
