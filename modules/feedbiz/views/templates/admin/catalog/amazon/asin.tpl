...
<tr class="amazon-details amazon-item-title">
    <td class="col-left">{l s='ASIN' mod='feedbiz'}</td>
    <td style="padding-bottom:5px;">
        <input type="text" name="asin1" value="{$data.default|escape:'htmlall':'UTF-8'}" style="width:120px"/>

        &nbsp;&nbsp;&nbsp; <span class="amz-small-line">{l s='ASIN is optional' mod='feedbiz'}</span>
