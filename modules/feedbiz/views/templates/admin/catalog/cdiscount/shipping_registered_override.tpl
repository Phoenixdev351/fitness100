...
<tr class="cdiscount-details cdiscount-item-title">
    <td class="col-left" rel="shipping_registered_override"><span>{l s='Override Registered Shipping Charges' mod='feedbiz'}</span></td>
    <td style="padding-bottom:5px;">
        <input type="text" name="shipping_registered_override" value="{$data.default|escape:'htmlall':'UTF-8'}" style="width:60px"/>
        <br/>
        <span class="amz-small-line">{l s='Registered shipping charges that override the default ones fixed in your Cdiscount Backoffice.' mod='feedbiz'}</span><br/>
