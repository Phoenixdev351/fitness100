...
<tr>
    <td colspan="2">
        <div id="productfeedbiz-options">
            ...
            <img src="{$images|escape:'htmlall':'UTF-8'}plus.png" rel="{$images|escape:'htmlall':'UTF-8'}minus.png" alt="" style="position:relative;top:-1px;"
                 id="feedbiz-toggle-img"/>
...
<tr class="feedbiz-details">
    <td style="padding-bottom:5px;"><br/>
        ...
        <input type="hidden" id="feedbiz-text-propagate-cat"
               value="{l s='Be carefull ! Are you sure to want set this value for all the products of this Category ?' mod='feedbiz'}"/>
        <input type="hidden" id="feedbiz-text-propagate-shop"
               value="{l s='Be carefull ! Are you sure to want to set this value for all the products of the entire Shop ?' mod='feedbiz'}"/>
        <input type="hidden" id="feedbiz-text-propagate-man"
               value="{l s='Be carefull ! Are you sure to want to set this value for all the products for this Manufacturer ?' mod='feedbiz'}"/>
    </td>
</tr>
<tr class="feedbiz-details">
        ...
        <span style="margin-left:10px">{l s='Check this box to make this product unavailable on Feed.biz' mod='feedbiz'}</span><br/>
            <span style="font-size:0.9em;color:grey;line-height:150%">{l s='Make all the products unavailable in this' mod='feedbiz'}
                ...
                <a href="javascript:void(0)"
                   class="feedbiz-propagate-disable-cat propagate">[ {l s='Category' mod='feedbiz'} ]</a>&nbsp;&nbsp;
                <a href="javascript:void(0)"
                   class="feedbiz-propagate-disable-shop propagate">[ {l s='Shop' mod='feedbiz'} ]</a>&nbsp;&nbsp;
                <a href="javascript:void(0)"
                   class="feedbiz-propagate-disable-manufacturer propagate">[ {l s='Manufacturer' mod='feedbiz'}
                    ]</a></span></span>
        <span id="feedbiz-extra-disable-loader" style="display:none"><img src="{$images|escape:'htmlall':'UTF-8'}green-loader.gif"
    ...
    <td style="padding-bottom:5px;">
        ...
        <span style="margin-left:10px">{l s='The product will always appear on feedbiz, even it\'s out of Stock' mod='feedbiz'}</span><br/>
            <span style="font-size:0.9em;color:grey;line-height:150%">{l s='Force as available in stock for all products in this' mod='feedbiz'}
                :
                <a href="javascript:void(0)"
                   class="feedbiz-propagate-force-cat propagate">[ {l s='Category' mod='feedbiz'} ]</a>&nbsp;&nbsp;
                <a href="javascript:void(0)" class="feedbiz-propagate-force-shop propagate">[ {l s='Shop' mod='feedbiz'}
                    ]</a>&nbsp;&nbsp;
                <a href="javascript:void(0)"
                   class="feedbiz-propagate-force-manufacturer propagate">[ {l s='Manufacturer' mod='feedbiz'}
                    ]</a></span></span>
        <span id="feedbiz-extra-force-loader" style="display:none"><img src="{$images|escape:'htmlall':'UTF-8'}green-loader.gif"
                                                                        style="margin-left:5px;" alt=""/></span>
    </td>
</tr>
...
<tr class="feedbiz-details">
    ...
    <td style="padding-bottom:5px;">
        <input type="text" name="feedbiz-price-{$id_lang|intval}" value="{$extraPrice|escape:'htmlall':'UTF-8'}" style="width:95px"/>
        <span style="font-size:0.9em;color:grey;line-height:150%">{l s='Net Price for Feed.biz. This value will override your Shop Price' mod='feedbiz'}</span>
    </td>
</tr>
...
<tr class="feedbiz-details">
    ...
    <td style="padding-bottom:5px;">
        <input type="text" name="feedbiz-shipping-delay-{$id_lang|intval}" value="{$shippingDelay|escape:'htmlall':'UTF-8'}" style="width:95px"/>
    </td>
</tr>
...
<tr class="feedbiz-details">
    ...
    <td style="padding:0 30px 5px 0;float:right;">
        ...
        <input type="button" style="float:right" id="productfeedbiz-save-options" class="button"
               value="{l s='Save Feed.biz  Parameters' mod='feedbiz'}"/>
    </td>
</tr>
{if isset($PS14)}
    <tr>
