...
class StWishlist extends Module implements WidgetInterface
{
    ...
    {
        $this->_tabs = array(
            array('id'  => '0,1,6,3', 'name' => $this->getTranslator()->trans('General settings', array(), 'Admin.Theme.Transformer')),
    ...
    protected function initForm()
    {
        ...
        $this->fields_form[6]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Settings for wishlist icons on the product image', array(), 'Admin.Theme.Transformer'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
