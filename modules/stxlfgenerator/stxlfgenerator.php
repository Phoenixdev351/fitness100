...
class StXlfGenerator extends Module
{
    ...
    public static $modules = array(
        ...
        array('val'=>'stcompare', 'id'=>'[]', 'name'=>'stcompare'),
	...
	public function getContent()
    {
        ...
        if (Tools::isSubmit('generatefiles'))
        {
            ...
            if ($dumper->dump($options)) {
                // Copy Xliff file /app/Resources/translations/default
                ...
                // Copy Xliff file to app/Resources/translations/locale
                $des = _PS_CORE_DIR_.'/app/Resources/translations/'.$locale.'/';
                $dumper->CopyFiles($save_path, $des, 'ModulesSt', $locale, false);
                $dumper->CopyFiles($save_path, $des, 'AdminTheme'.ucfirst($this->theme), $locale, false);
