...
<div id="viewed_top" class="top_bar_item dropdown_wrap">
	<div class="dropdown_tri dropdown_tri_in header_item" aria-haspopup="true" aria-expanded="false">
        <i class="fto-history icon_btn mar_r4"></i><span id="viewed_top_lable">{l s='Recently Viewed' d='Shop.Theme.Transformer'}</span>{if $show_viewed_nbr}<span class="products_viewed_nbr amount_inline mar_l4">{if isset($viewed_products) && count($viewed_products)}{count($viewed_products)}{else}0{/if}</span>{/if}
	...
	<div class="dropdown_list" aria-labelledby="viewed_top_lable">
        <div class="dropdown_box dropdown_box_viewed">
			{if isset($viewed_products) && count($viewed_products)}
				<div class="viewed_products_list base_list_line">
