...
class SequraOrderCanceller
{
     ...
     *
     * @return SequraOrderCanceller
     */
    public static function getInstance($context_or_webhook, $order_id = null)
    {
        static $inst = null;
        if ($inst === null) {
            $inst = new SequraOrderCanceller($context_or_webhook, $order_id);
        }
        return $inst;
    }
    ...
    public function cancelOrder()
    {
        ...
        $history->changeIdOrderState(Configuration::get('SEQURA_OS_CANCELED'), (int)($this->order->id));
        $history->addWithemail();
        $history->save();
    }

    public function checkIfPreconditionsAreMissing($newOrderStatus = null)
    {
    ...
    public function prepareSequra()
    {
        ...
        $builder = new SequraOrderBuilder($merchant_id, $this->cart, $pm);
