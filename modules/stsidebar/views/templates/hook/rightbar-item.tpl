...
{if $sidebar_item.native_modules==1}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_cart rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_products_cart" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='View my shopping cart' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==2}
	<section id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_compare rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_products_compared" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" href="{$link->getPageLink('products-comparison')|escape:'html'}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Compare Products' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==4}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_qrcode rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_qrcode" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='QR code' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==6}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_menu rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
		<a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_stmobilemenu" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Menu' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==7}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_nav rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_mobile_nav" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Settings' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==8}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_search rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_search" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Search' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==14}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_advanced_search rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}"  class=" {else} href="javascript:;"  class="rightbar_tri {/if} icon_wrap with_text" data-name="side_advanced_search" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Search' d='Shop.Theme.Transformer'}{/if}">
	        <i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{else}fto-search-1{/if}"></i>
	        <span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Search' d='Shop.Theme.Transformer'}{/if}</span>
	    </a>
	</div>
{elseif $sidebar_item.native_modules==9}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_share rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_share" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Share' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==10}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_loved rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}" class=" {else} href="javascript:;" class="rightbar_tri {/if} icon_wrap with_text" data-name="side_loved" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Loved products' d='Shop.Theme.Transformer'}{/if}">
...
{elseif $sidebar_item.native_modules==13}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_compare rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="{if isset($sidebar_item.url) && $sidebar_item.url}{$sidebar_item.url}{else}{$stcompare_url}{/if}" class="icon_wrap with_text" data-name="side_compare" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Product comparison' d='Shop.Theme.Transformer'}{/if}">
		...
		{foreach $nav_products as $nav => $product}
			{if $product}
				<div id="rightbar_{$sidebar_item.id_st_sidebar}_{$nav}" class="rightbar_product_link_nav rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
				    <a class="icon_wrap with_text" href="{$product.url}" data-name="side_productlinknav" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $nav=='prev'}{l s='Previous product' d='Shop.Theme.Transformer'}{/if}{if $nav=='next'}{l s='Next product' d='Shop.Theme.Transformer'}{/if}"><i class="{if $sidebar_item.icon_class}{if $nav=='prev'}{$sidebar_item.icon_class}{/if}{if $nav=='next'}{$sidebar_item.icon_class|replace:'left':'right'}{/if}{else}fto-{if $nav=='prev'}left{/if}{if $nav=='next'}right{/if}{/if}"></i><span class="icon_text">{if $nav=='prev'}{l s='Prev' d='Shop.Theme.Transformer'}{/if}{if $nav=='next'}{l s='Next' d='Shop.Theme.Transformer'}{/if}</span></a>
				</div>
			{/if}
		{/foreach}
	{/if}
...
{elseif $sidebar_item.native_modules==16}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_customersignin rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a href="{if isset($sidebar_item.url) && $sidebar_item.url}{$sidebar_item.url}{else}{url entity='my-account'}{/if}" class="icon_wrap with_text" data-name="side_customersignin_{$sidebar_item.id_st_sidebar}" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{if $logged}{l s='My account' d='Shop.Theme.Transformer'}{else}{l s='Login' d='Shop.Theme.Transformer'}{/if}{/if}">
	        <i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{else}fto-user{/if}"></i>
	        <span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{if $logged}{l s='My account' d='Shop.Theme.Transformer'}{else}{l s='Login' d='Shop.Theme.Transformer'}{/if}{/if}</span>
	    </a>
	</div>
{elseif $sidebar_item.native_modules==17}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_language rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}"  class=" {else} href="javascript:;"  class="rightbar_tri {/if} icon_wrap with_text" data-name="side_language" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Language switcher' d='Shop.Theme.Transformer'}{/if}">
	        <i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{/if}">{if !$sidebar_item.icon_class}{$language.iso_code}{/if}</i>
	        <span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Language' d='Shop.Theme.Transformer'}{/if}</span>
	    </a>
	</div>
{elseif $sidebar_item.native_modules==18}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_currency rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
	    <a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}"  class=" {else} href="javascript:;"  class="rightbar_tri {/if} icon_wrap with_text" data-name="side_currency" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Currency switcher' d='Shop.Theme.Transformer'}{/if}">
	        <i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{/if}">{if !$sidebar_item.icon_class}{$currency.sign}{/if}</i>
	        <span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Currency' d='Shop.Theme.Transformer'}{/if}</span>
	    </a>
	</div>
{elseif $sidebar_item.native_modules==19}
	<div id="rightbar_{$sidebar_item.id_st_sidebar}" class="rightbar_menu rightbar_wrap rightbar_visi_{$sidebar_item.hide_on_mobile}">
		<a {if isset($sidebar_item.url) && $sidebar_item.url} href="{$sidebar_item.url}"  class=" {else} href="javascript:;"  class="rightbar_tri {/if} icon_wrap with_text" data-name="side_steasymenu" data-direction="open_bar_{if $sidebar_item.direction==2}left{else}right{/if}" rel="nofollow" title="{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Menu' d='Shop.Theme.Transformer'}{/if}">
		    <i class="{if $sidebar_item.icon_class}{$sidebar_item.icon_class}{else}fto-menu{/if}"></i>
		    <span class="icon_text">{if $sidebar_item.title}{$sidebar_item.title}{else}{l s='Menu' d='Shop.Theme.Transformer'}{/if}</span>
		</a>
	</div>
