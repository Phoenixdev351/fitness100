...
*}
	...
	$(document).ready(function(){
        ...
        $('#product_name').autocomplete('index.php?controller=AdminModules&configure=stthemeeditor&token={Tools::getAdminTokenLite('AdminModules')}&ajax_products_list&disableCombination=true', {
            minChars: 1,
            autoFill: true,
            max:20,
            matchContains: true,
