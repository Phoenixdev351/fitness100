...
<div class="block_blog {if isset($classname)} {$classname} {/if}">
    ...
    <div class="pro_first_box">
        {include file='module:stblog/views/templates/slider/post-cover.tpl' show_video=1 no_google_rich_snippets=1}
    ...
    <div class="pro_second_box pro_block_align_{$stblog.blog_block_align}">
        ...
        <div class="blog_info">
            ...
            {if $stblog.display_comment_count && isset($blog.comment_counter) && $blog.comment_counter}<a href="{$blog.link}#comments" title="{$blog.comment_counter} {if $blog.comment_counter>1}{l s='Comments' d='Shop.Theme.Transformer'}{else}{l s='Comment' d='Shop.Theme.Transformer'}{/if}"><i class="fto-chat-1 mar_r4"></i>{$blog.comment_counter}</a>{/if}
