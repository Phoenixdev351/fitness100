...
return array(
	'setting' => array(
        'rount_name' => array(
			...
			'size' => 60,                        
			'type' => 'text',
            'desc' => $this->getTranslator()->trans('The default is "blog"', array(), 'Modules.Stblog.Admin'),                        
		),
         'show_all' => array(
        ...
        'home_sort_by' => array(
            'label' => $this->getTranslator()->trans('Default sort by for blog homepage', array(), 'Modules.Stblog.Admin'),
            'name' => 'home_sort_by',
        ...
        'block_headings_bg'=>array(
            'type' => 'color',
            'label' => $this->getTranslator()->trans('Heading background color:', array(), 'Modules.Stblog.Admin'),
            'name' => 'block_headings_bg',
            'class' => 'color',
            'size' => 20,
            'validation' => 'isColor',
        ),
