...
class StPageBanner extends Module implements WidgetInterface
{
	...
	{        
		...
		$this->fields_form_banner[0]['form'] = array(
			...
			'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->getTranslator()->trans('Show on subcategories:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'show_subcate',
                    'default_value' => 0,
                    'is_bool' => true,
                    'values' => array(
                    ...
                    'desc' => $this->getTranslator()->trans('Show on sub categories, just for category only.', array(), 'Admin.Theme.Transformer'),
                ),
                array(
                    'type' => 'text',
        ...
        $this->fields_form_banner[1]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Add custom content', array(), 'Modules.Stpagebanner.Admin'),
                'icon'  => 'icon-cogs'
            ),
            'input' => array(
                array(
                ...
                array(
                 ...
                 array(
                    'type' => 'textarea',
                    'label' => $this->getTranslator()->trans('Custom content:', array(), 'Admin.Theme.Transformer'),
                    'lang' => true,
                    'name' => 'description',
                    'cols' => 40,
                    'rows' => 10,
                    'autoload_rte' => true,
                    'desc' => array(
                            $this->getTranslator()->trans('Format your entry with some basic HTML.', array(), 'Modules.Stpagebanner.Admin'),
    ...
    {
        return array(
            'authentication' => array('id'=>'10_authentication', 'name'=>$this->getTranslator()->trans('Login', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Login', array(), 'Shop.Theme.Transformer')),
            'my-account' => array('id'=>'10_my-account', 'name'=>$this->getTranslator()->trans('My account', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Manage my customer account', array(), 'Shop.Theme.Transformer')),
            'order-follow' => array('id'=>'10_history', 'name'=>$this->getTranslator()->trans('My orders', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('My orders', array(), 'Shop.Theme.Transformer')),
            'order-follow' => array('id'=>'10_order-follow', 'name'=>$this->getTranslator()->trans('My merchandise returns', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('My returns', array(), 'Shop.Theme.Transformer')),
            'order-slip' => array('id'=>'10_order-slip', 'name'=>$this->getTranslator()->trans('My credit slips', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('My credit slips', array(), 'Shop.Theme.Transformer')),
            'addresses' => array('id'=>'10_addresses', 'name'=>$this->getTranslator()->trans('My addresses', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('My addresses', array(), 'Shop.Theme.Transformer')),
            'identity' => array('id'=>'10_identity', 'name'=>$this->getTranslator()->trans('My personal info', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Manage my personal information', array(), 'Shop.Theme.Transformer')),
            'discount' => array('id'=>'10_discount', 'name'=>$this->getTranslator()->trans('My vouchers', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('My vouchers', array(), 'Shop.Theme.Transformer')),
        );
    }
    ...
    {
        return array(
            'prices-drop' => array('id'=>'10_prices-drop', 'name'=>$this->getTranslator()->trans('Specials', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Specials', array(), 'Shop.Theme.Transformer')),
            'new-products' => array('id'=>'10_new-products', 'name'=>$this->getTranslator()->trans('New products', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('New products', array(), 'Shop.Theme.Transformer')),
            'best-sales' => array('id'=>'10_best-sales', 'name'=>$this->getTranslator()->trans('Top sellers', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Top sellers', array(), 'Shop.Theme.Transformer')),
            'stores' => array('id'=>'10_stores', 'name'=>$this->getTranslator()->trans('Our stores', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Our stores', array(), 'Shop.Theme.Transformer')),
            'contact' => array('id'=>'10_contact', 'name'=>$this->getTranslator()->trans('Contact us', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Contact us', array(), 'Shop.Theme.Transformer')),
            'sitemap' => array('id'=>'10_sitemap', 'name'=>$this->getTranslator()->trans('Sitemap', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Sitemap', array(), 'Shop.Theme.Transformer')),
            'manufacturer' => array('id'=>'10_manufacturer', 'name'=>$this->getTranslator()->trans('Manufacturers', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Manufacturers', array(), 'Shop.Theme.Transformer')),
            'supplier' => array('id'=>'10_supplier', 'name'=>$this->getTranslator()->trans('Suppliers', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Suppliers', array(), 'Shop.Theme.Transformer')),
            'checkout' => array('id'=>'10_checkout', 'name'=>$this->getTranslator()->trans('Checkout', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Checkout', array(), 'Shop.Theme.Transformer'), 'php_self'=>'order'),
            'order-confirmation' => array('id'=>'10_order-confirmation', 'name'=>$this->getTranslator()->trans('Order confirmation', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Order confirmation', array(), 'Shop.Theme.Transformer')),
            'search' => array('id'=>'10_search', 'name'=>$this->getTranslator()->trans('Search', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Search', array(), 'Shop.Theme.Transformer')),
            'cart' => array('id'=>'10_cart', 'name'=>$this->getTranslator()->trans('Shopping cart', array(), 'Shop.Theme.Transformer'), 'title'=>$this->getTranslator()->trans('Shopping cart', array(), 'Shop.Theme.Transformer')),
        );
    }
    ...
    public function hookDisplayBreadcrumb($params)
    {
        ...
        if($page_name =='product' )
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,12)) || $this->_prepareHook($id,12))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,12));
            }*/
            $product = new Product($id);
            if ($product->id_category_default) {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($product->id_category_default.'-'.$id,1)) || $this->_prepareHook($product->id_category_default,1))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($product->id_category_default.'-'.$id,1));
            }
        }
        elseif($page_name =='category' )
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,1)) || $this->_prepareHook($id,1))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,1));
            }
        }
        elseif($page_name=='manufacturer')
        {
            $this->assignBreadCrumb($page_name, $information);
            if($id = (int)Tools::getValue('id_manufacturer'))
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,4)) || $this->_prepareHook($id,4))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,4));
            }
        }
        elseif($page_name=='supplier')
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,5)) || $this->_prepareHook($id,5))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,5));
            }
        }
        elseif($page_name=='cms')
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,3)) || $this->_prepareHook($id,3))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,3));
            }
            else if ($id = (int)Tools::getValue('id_cms_category'))
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,6)) || $this->_prepareHook($id,6))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,6));
            }
        }
        elseif($page_name=='module-stblog-category')
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,8)) || $this->_prepareHook($id,8))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,8));
            }
        }
        elseif($page_name=='module-stblog-article')
        {
            ...
            {
                if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,9)) || $this->_prepareHook($id,9))
                    $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($id,9));
            }*/
        }
        ...
        {
            if (!$this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($page_name,10))) {
                $this->assignBreadCrumb($page_name, array_merge($information, $myAccount));
                $this->_prepareHook($page_name,10);
            }
            $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($page_name,10));
        }
        
        if(!$res && $page_name != 'index' && $page_name != 'pagenotfound')// && $page_name != 'module-stblog-default'
        {
            if ($this->isCached($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($page_name, $id)) || $this->_prepareHook(1, 11))
                $res = $this->fetch($this->templatePath.'stpagebanner.tpl', $this->stGetCacheId($page_name, $id));
        }
        return $res ? $res : '';
    }
    public function assignBreadCrumb($page_name = '', $pages=array())
    {
        if (!$page_name || !$pages || !is_array($pages)) {
            return false;
        }
        if (!array_key_exists($page_name, $pages)) {
            return false;
        }
        $breadcrumb = $this->context->smarty->getTemplateVars('breadcrumb');
        if ($breadcrumb['count'] <= 1) {
            $title = $pages[$page_name]['name'];
            $breadcrumb['links'][] = array(
                'title' => $title,
                'url' => $this->context->link->getPageLink(array_key_exists('php_self', $pages[$page_name]) ? $pages[$page_name]['php_self'] : $page_name),
            );
            $breadcrumb['count']++;
