...
class StTags extends Module implements WidgetInterface
{
    ...
    function install()
    {
        $success = (parent::install()
            ...
            && Configuration::updateValue('BLOCKTAGS_HIDE_ON_MOBILE', 0)
        );
        return $success;
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitBlockTags'))
        {
            ...
            Configuration::updateValue('BLOCKTAGS_HIDE_ON_MOBILE', (int)Tools::getValue('blocktags_hide_on_mobile'));
    ...
    public function renderForm()
    {
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('How many tags do you want to display.', array(), 'Modules.Sttags.Admin'),
                    'name' => 'blocktags_nbr',
    ...
    {       
        $fields_values = array(
            ...
            'blocktags_hide_on_mobile' => (int)Configuration::get('BLOCKTAGS_HIDE_ON_MOBILE'),
        );
    ...
    {
        $tags_nbr = isset($configuration['tag_nbr']) ? (int)$configuration['tag_nbr'] : (int)Configuration::get('BLOCKTAGS_NBR');
        !$tags_nbr && $tags_nbr = 10;
        $tags = Tag::getMainTags((int)($this->context->language->id), $tags_nbr);
        ...
        return array(
            ...
            'blocktags_align' => (int)Configuration::get('BLOCKTAGS_ALIGN'),
            'blocktags_title' => (int)Configuration::get('BLOCKTAGS_TITLE'),
            'hide_on_mobile' => (int)Configuration::get('BLOCKTAGS_HIDE_ON_MOBILE'),
        );
    ...
    public function vc_shortcode_init($atts, $content = null)
    {
        ...
        return $this->renderWidget($hook, array('tag_nbr'=>$tag_nbr,'st_time'=>$st_time));
    ...
    function vc_map_init()
    {
        ...
        $params = array(
            ...
            'params' => array(
                ...
                array(
                    'type' => 'textfield',
                    'heading' => $this->getTranslator()->trans('How many tags to be displayed:', array(), 'Modules.Sttags.Admin'),
                    'class' => 'hide_in_vc_editor',
                    'holder' => 'div',
                    'param_name' => 'tag_nbr',
