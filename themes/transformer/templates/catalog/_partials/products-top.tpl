...
<div id="js-product-list-top" class="products-selection flex_container general_top_border general_bottom_border">
    ...
    {if !empty($listing.rendered_facets) && !$filter_position && $sttheme.slide_lr_column}
    ...
    {/if}
      ...
      {/block}
  <div class="list_grid_switcher {if !$sttheme.product_view_swither} display_none {/if}">
  ...
  {include file='catalog/_partials/number-per-page.tpl'}
