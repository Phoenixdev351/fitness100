        ...
        <div class="row">
          <div class="col-md-6 col-6 qty">
            ...
            {else}
              <div class="qty_wrap">
                <input
                  class="js-cart-line-product-quantity cart_quantity cart_quantity_{$product.id_product} {if $product.quantity>=$product.stock_quantity} hits_the_max_limit{/if} {if $product.quantity<=$product.minimal_quantity} hits_the_min_limit{/if}"
