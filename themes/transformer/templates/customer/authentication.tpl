...
{if $sttheme.auth_login_width}{$auth_login_width=$sttheme.auth_login_width}{/if}
    ...
    {block name='new_customers_container'}
      <div class="create_account_column col-lg-{12-$auth_login_width}">
    ...
    {block name='login_form_container'}
      <div class="login_form_column {if $sttheme.auth_layout} col-lg-{$auth_login_width} {else} col-lg-{$auth_login_width} {if $layout=='layouts/layout-full-width.tpl'}offset-lg-{floor((12-$auth_login_width)/2)}{/if} {/if}">{*to do looking for a better way to tell if has columns*}
